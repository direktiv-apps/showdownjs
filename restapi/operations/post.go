...
type PostBody struct {
	...
	// Scope of the saved html output within the scope.
	// Example: myhtml
	Name string `json:"name,omitempty"`

	// Scope of the saved html output. If empty result will be returned as base64.
	// Example: instance
...
var postBodyTypeScopePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["workflow","namespace","instance"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		postBodyTypeScopePropEnum = append(postBodyTypeScopePropEnum, v)
	}
}

const (

	// PostBodyScopeWorkflow captures enum value "workflow"
	PostBodyScopeWorkflow string = "workflow"

	// PostBodyScopeNamespace captures enum value "namespace"
	PostBodyScopeNamespace string = "namespace"

	// PostBodyScopeInstance captures enum value "instance"
	PostBodyScopeInstance string = "instance"
)

// prop value enum
func (o *PostBody) validateScopeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, postBodyTypeScopePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *PostBody) validateScope(formats strfmt.Registry) error {
