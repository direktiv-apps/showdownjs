...
//go:generate swagger generate server --target ../../app --name Showdownjs --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.ShowdownjsAPI) {
...
func configureAPI(api *operations.ShowdownjsAPI) http.Handler {
